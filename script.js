$(document).ready(function() {
  const apiRoot = 'https://infinite-atoll-21692.herokuapp.com/v1/task/';
  const trelloApiRoot = 'https://infinite-atoll-21692.herokuapp.com/v1/trello/';
  ...
  function handleCardCreationRequest(event) {
    var requestUrl = trelloApiRoot + 'cards/new';
